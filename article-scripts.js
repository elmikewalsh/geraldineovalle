    ...
    var pg = {
      ...
      init: function(){
        ...
        _doc.on("click", ".pgalbumlink",function(e){
          ...
          if(pg.type == 'local') {
						var galleryID = $(this).attr('data-album-index').replace('//', '').replace('//', '').replace('https://', '');
      ...
      writeHTML: function(){
        ...
        if(pg.credit === true) {
          lmnt.append('<div id="pgcredit"><a href="//www.plusgallery.net" target="_blank" title="Powered by +GALLERY"><span>+</span>Gallery</a></div>');
        }
          ...
          if(albumTotal > 0 ) {
            $.each(objPath,function(i,obj){
              ...
              if(i < albumTotal){
                ...
                galleryImage = '//farm' + obj.farm + '.staticflickr.com/' + obj.server + '/' + obj.primary + '_' + obj.secret + '_n.jpg';
                galleryJSON = '//api.flickr.com/services/rest/?&method=flickr.photosets.getPhotos&api_key=' + pg.apiKey + '&photoset_id=' + obj.id + '=&format=json&jsoncallback=?';
          ...
          if(albumTotal > 0) {
            $.each(objPath,function(i,obj){
              if(i < albumTotal){
                ...
                galleryImage = '//graph.facebook.com/' + obj.id + '/picture?type=album';
                pg.loadAlbums(galleryTitle,galleryImage,galleryJSON);
              }
      ...
      loadAlbumData: function() {
        ...
        case 'google':
          ...
          break;
        case 'flickr':
          albumURL = '//api.flickr.com/services/rest/?&method=flickr.photosets.getList&api_key=' + pg.apiKey + '&user_id=' + pg.userId + '&format=json&jsoncallback=?';
          break;
        case 'facebook':
      ...
      loadSingleAlbum:function(){
        ...
        case 'google':
          ...
          break;
        case 'flickr':
          url = '//api.flickr.com/services/rest/?&method=flickr.photosets.getPhotos&api_key=' + pg.apiKey + '&photoset_id=' + pg.albumId + '=&format=json&jsoncallback=?';
          pg.loadGallery(url);
          break;
        case 'facebook':
      ...
      parseData: function(json,title){
        ...
        $.each(objPath,function(i,obj){
          ...
          if(i < pg.limit) {
            ...
            case 'flickr':
              imgTitle = obj.title;
              imgSrc = '//farm' + obj.farm + '.staticflickr.com/' + obj.server + '/' + obj.id + '_' + obj.secret + flickrImgExt + '.jpg';
              imgTh = '//farm' + obj.farm + '.staticflickr.com/' + obj.server + '/' + obj.id + '_' + obj.secret + '_q.jpg';
              break;
            case 'facebook':
              imgTitle = obj.name;
